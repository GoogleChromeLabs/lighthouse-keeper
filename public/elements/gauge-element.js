...
import '../node_modules/lighthouse/lighthouse-core/report/html/renderer/util.js';
...
class GaugeElement extends HTMLElement {
  static get is() { return 'gauge-element'; }
...
if (window.ShadyCSS) {
  ShadyCSS.prepareTemplate(tmpl, GaugeElement.is);
}

window.customElements.define(GaugeElement.is, GaugeElement);
